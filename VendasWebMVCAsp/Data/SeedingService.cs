...
using VendasWebMVCAsp.Models.Enum;

namespace VendasWebMVCAsp.Data
{
    public class SeedingService
    {
        private VendasWebMVCAspContext _context;


        public SeedingService(VendasWebMVCAspContext context) {
            _context = context;
        }
